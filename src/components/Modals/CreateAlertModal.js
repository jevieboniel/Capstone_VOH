    ...
    import { Bell, X, Mail, Send } from "lucide-react";
    ...
    return (
        ...
        >
            ...
            Notify users by role via <span className="font-semibold">Email</span>.
            </p>
            ...
            <div>
                ...
                Selected: {newAlert.recipients.length} roles
                </p>
            </div>
            ...
            <div className="rounded-xl bg-blue-50 dark:bg-blue-500/10 px-4 py-3 text-xs text-blue-800 dark:text-blue-200 border border-blue-100 dark:border-blue-500/20">
                ...
                {newAlert.recipients.length} role
